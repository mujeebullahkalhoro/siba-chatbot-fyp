# rag/retrievers/universal_retriever.py
...
# =========================
class UniversalBM25Retriever(BaseRetriever):
    """BM25 Retriever over ALL documents — handles both TXT and PDF."""
    ...
    def __init__(self, k: int = 6):
        ...
        if not corpus:
            raise ValueError("No data found for universal BM25 retriever")
